...
public class TestQueryMainOrderBySerializedId {
    ...
    public void ms_c__queryMainOrderBySerializedId_01(JSONObject request, JSONObject expect){
        QueryOrderResponse result = queryMainOrder4MTService.queryMainOrderBySerializedId(request.getString("serializedId"));
