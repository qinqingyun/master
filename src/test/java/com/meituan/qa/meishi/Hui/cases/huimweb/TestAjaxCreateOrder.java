...
@ClassAnnotation(author = "liukang",depart = "C",apiName = "hui/cashier/ajaxcreateorder",
        type = "http",des="m站下单")
@Slf4j
public class TestAjaxCreateOrder extends TestBase {
    @Test(groups = {"P1"})
    @MethodAnotation(author = "liukang",createTime = "2018-10-17",updateTime = "2018-10-17",des = "正确创单")
    public void ms_c_ajaxcreateorder_01() throws UnsupportedEncodingException {
        //OrderModel orderModel = loopCheck.uniCashierCreateOrder("ms_c_ajaxcreateorder_01");
        ResponseMap responseMap = huiMWebApi.ajaxCreateOrder("ms_c_ajaxcreateorder_01");
