...
@Slf4j
public class TestdpWeixinShopPromoScence extends TestDPLogin {
    ...
    public void ms_c_dpWeixinShopPromoScence() throws Exception {
        ...
        //1、输入金额创建订单（下单支付）
        Map<String, String> wxaOrderCreateResult = CreateOrderUtil.wxaCreateOrder(dpToken,"ms_c_wxShopPromoCreateOrder_01",0, null,deskCoupon);
