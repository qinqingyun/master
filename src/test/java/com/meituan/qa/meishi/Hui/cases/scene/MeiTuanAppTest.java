...
public class MeiTuanAppTest extends TestBase {
    ...
    public void mtOriginTest() throws Exception {
        ...
        //9.用户订单详情页校验
        CheckOrderUtil.checkOrderDetail(orderDetailCaseId,orderModel);
        //10.商户订单详情页校验
        //11.商户订单中心推送校验
        //12.商家直退
    ...
    public void mtShopPromoTest() throws Exception {
        ...
        if(deskCoupon == null){
            ...
            MaitonHongbaoTResponse maitonHongbaoTResponse = loopCheck.setShopPromo(maitonApi.getUserModel(), 97224769);
...
//        log.info("折扣couponOfferId:{}" + JSON.toJSONString(couponProduct));
    ...
    public void mtCouponPromoTest() throws Exception {
        ...
        DeskCoupon deskCoupon = loopCheck.getShopCouponCipher(couponId,getHuiPromodeskCaseId);
        //2.若没有商家券，调用发券接口发券
        if(deskCoupon == null){
            UnifiedCouponIssueResponse unifiedCouponIssueResponse = loopCheck.setCouponPromo(maitonApi.getUserModel(), 549009064);
            ...
            //下单前查询优惠
            deskCoupon = loopCheck.getShopCouponCipher(couponId,getHuiPromodeskCaseId);
