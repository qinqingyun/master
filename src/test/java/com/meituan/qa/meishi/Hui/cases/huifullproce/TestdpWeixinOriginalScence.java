...
@Slf4j
public class TestdpWeixinOriginalScence extends TestDPLogin {
    ...
    public void ms_c_dPWeixinoriginalScenes() throws Exception {
        ...
        //1、输入金额创建订单（下单支付）
        Map<String, String> wxaOrderCreateResult = CreateOrderUtil.wxaCreateOrder(dpToken,"ms_c_wxOriginCreateOrder_01", 0, null,null);
