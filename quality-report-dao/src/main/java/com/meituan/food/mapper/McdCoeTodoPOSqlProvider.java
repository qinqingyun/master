...
import com.meituan.food.po.McdCoeTodoPOExample.Criteria;
import com.meituan.food.po.McdCoeTodoPOExample.Criterion;
import com.meituan.food.po.McdCoeTodoPOExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class McdCoeTodoPOSqlProvider {

    public String countByExample(McdCoeTodoPOExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("mcd_todo_list");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(McdCoeTodoPOExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("mcd_todo_list");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(McdCoeTodoPO record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("mcd_todo_list");
    ...
    public String selectByExample(McdCoeTodoPOExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        McdCoeTodoPO record = (McdCoeTodoPO) parameter.get("record");
        McdCoeTodoPOExample example = (McdCoeTodoPOExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("mcd_todo_list");
    ...
    public String updateByPrimaryKeySelective(McdCoeTodoPO record) {
        SQL sql = new SQL();
        sql.UPDATE("mcd_todo_list");
    ...
    protected void applyWhere(SQL sql, McdCoeTodoPOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
