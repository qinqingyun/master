...
public class BCrashRatePOSqlProvider {
    ...
    public String insertSelective(BCrashRatePO record) {
        ...
        if (record.getPlatfrom() != null) {
            sql.VALUES("platfrom", "#{platfrom,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPlatfrom() != null) {
            sql.SET("platfrom = #{record.platfrom,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(BCrashRatePO record) {
        ...
        if (record.getPlatfrom() != null) {
            sql.SET("platfrom = #{platfrom,jdbcType=VARCHAR}");
        }
