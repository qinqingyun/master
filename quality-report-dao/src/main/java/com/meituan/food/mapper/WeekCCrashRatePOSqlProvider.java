...
import com.meituan.food.po.WeekCCrashRatePOExample.Criteria;
import com.meituan.food.po.WeekCCrashRatePOExample.Criterion;
import com.meituan.food.po.WeekCCrashRatePOExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class WeekCCrashRatePOSqlProvider {

    public String countByExample(WeekCCrashRatePOExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("week_c_crash_rate");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(WeekCCrashRatePOExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("week_c_crash_rate");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(WeekCCrashRatePO record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("week_c_crash_rate");
    ...
    public String selectByExample(WeekCCrashRatePOExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WeekCCrashRatePO record = (WeekCCrashRatePO) parameter.get("record");
        WeekCCrashRatePOExample example = (WeekCCrashRatePOExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("week_c_crash_rate");
    ...
    public String updateByPrimaryKeySelective(WeekCCrashRatePO record) {
        SQL sql = new SQL();
        sql.UPDATE("week_c_crash_rate");
    ...
    protected void applyWhere(SQL sql, WeekCCrashRatePOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
