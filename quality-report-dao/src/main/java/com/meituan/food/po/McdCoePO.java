...
public class McdCoePO implements Serializable {
    private Integer id;
    ...
    private String couponLoss;

    private String onlineDiscovery;

    private String onlineClassification;
    ...
    public String getCouponLoss() {
        return couponLoss;
    }

    public void setCouponLoss(String couponLoss) {
        this.couponLoss = couponLoss;
    }

    public String getOnlineDiscovery() {
        return onlineDiscovery;
    }

    public void setOnlineDiscovery(String onlineDiscovery) {
        this.onlineDiscovery = onlineDiscovery;
    }

    public String getOnlineClassification() {
        return onlineClassification;
    }

    public void setOnlineClassification(String onlineClassification) {
        this.onlineClassification = onlineClassification;
    }
    ...
    public String getNofundReason() {
        return nofundReason;
    }

    public void setNofundReason(String nofundReason) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCouponLoss() == null ? other.getCouponLoss() == null : this.getCouponLoss().equals(other.getCouponLoss()))
            && (this.getOnlineDiscovery() == null ? other.getOnlineDiscovery() == null : this.getOnlineDiscovery().equals(other.getOnlineDiscovery()))
            && (this.getOnlineClassification() == null ? other.getOnlineClassification() == null : this.getOnlineClassification().equals(other.getOnlineClassification()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCouponLoss() == null) ? 0 : getCouponLoss().hashCode());
        result = prime * result + ((getOnlineDiscovery() == null) ? 0 : getOnlineDiscovery().hashCode());
        result = prime * result + ((getOnlineClassification() == null) ? 0 : getOnlineClassification().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", couponLoss=").append(couponLoss);
        sb.append(", onlineDiscovery=").append(onlineDiscovery);
        sb.append(", onlineClassification=").append(onlineClassification);
