...
public class KmExtracter implements IOneWeekDataExtract {
    ...
    public void extractData4Week(LocalDate firstDay, LocalDate lastDay) {
        ...
        String body = combineBody(orderMisNames);
        String kmTitleHead="交易组覆盖率统计周报（";
        createReport(kmTitleHead+kmTitleTail, body);

        List<String> orderMisNames2 = ImmutableList.of("hanye03", "qinqingyun");
        body = combineBody(orderMisNames2);
        kmTitleHead="业务后台组覆盖率统计周报（";
        createReport(kmTitleHead+kmTitleTail, body);
    }

    private void createReport(String kmTitle, String body){
        ...
        params.put("parentId", "258410650");//122541012  258410650
    ...
    private String combineBody(List<String> orderMisNames){
        String body = "";
        body += tableHead;
